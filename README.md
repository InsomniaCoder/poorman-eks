...
> ~$107–132/mo for a minimal working cluster (eu-west-1), including the free S3 Gateway endpoint. See [ARCHITECTURE.md](./ARCHITECTURE.md) for a full breakdown and optional cost additions.
